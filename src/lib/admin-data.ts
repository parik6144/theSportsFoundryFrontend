...
export const adminNavGroups = [
  ...
  { label: "Content", items: [
    { id: "services", label: "Services", icon: "Squares2x2" },
    { id: "blog", label: "Blog Posts", icon: "DocumentText" },
    { id: "success-stories", label: "Success Stories", icon: "Star" },
    { id: "testimonials", label: "Testimonials", icon: "ChatBubbleLeftRight" },
    { id: "partners", label: "Partners", icon: "BuildingStorefront" },
  ]},
  { label: "People & Organizations", items: [
    { id: "athletes", label: "Athletes", icon: "UserCircle" },
    { id: "teams", label: "Teams", icon: "UserGroup" },
    { id: "academies", label: "Academies", icon: "AcademicCap" },
    { id: "brands", label: "Brands", icon: "BuildingOffice2" },
  ]},
  { label: "Events", items: [{ id: "events", label: "Events & Tournaments", icon: "Trophy" }] },
  { label: "Community", items: [{ id: "community", label: "Community Posts", icon: "ChatBubbleEllipsis" }] },
  { label: "Enquiries", items: [{ id: "enquiries", label: "Enquiries", icon: "Inbox", badge: "new" as const }] },
  { label: "System", items: [
